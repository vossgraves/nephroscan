...
MODEL_OUTPUT = r"C:\Users\Panchami.A\OneDrive\Desktop\NephroScan-AI\models\heart_cardiomegaly_resnet18.pth"
...
if train_dataset.classes != test_dataset.classes:
    raise RuntimeError(f"Train/test classes differ: {train_dataset.classes} vs {test_dataset.classes}")
...
for epoch in range(EPOCHS):
    ...
    if test_accuracy > best_accuracy:
        ...
        print("Saved best model to:", MODEL_OUTPUT)

print("========================================")
print("HEART CARDIOMEGALY MODEL TRAINING COMPLETE")
print("========================================")
